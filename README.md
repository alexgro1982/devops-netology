...
S3 бакет создан успешно. В main.tf добавлен бэкэнд.
...
alexgro@alex-book:~/Документы/netology/devops-netology/terraform$ terraform plan
...
Terraform will perform the following actions:
  ...
  # yandex_compute_instance.web_for["host1"] will be created
  ...
  # yandex_compute_instance.web_for["host2"] will be created
  + resource "yandex_compute_instance" "web_for" {
      + created_at                = (known after apply)
      + folder_id                 = (known after apply)
      + fqdn                      = (known after apply)
